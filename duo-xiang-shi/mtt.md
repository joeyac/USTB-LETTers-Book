...
在[icpc-camp](https://post.icpc-camp.org/d/408-fft)中看到的黑科技，发文者也提供了[github链接](https://github.com/fotile96/Z_m-PolyMult)，里面说的挺详细的，测试了一下，正确性是有保证的，但是速度还是稍微有点慢，然后在北航TJZ队伍的[wiki](https://wiki-three-investigators.icpc-camp.org/code%20library#fast-fourier-transform-in-modulo-any-integer)中找到了一份Fast Fourier transform in modulo any integer板子……
